...
define('APP_AUTHOR', 'Juan Ernesto (Eqnesto@gmail.com)');
...
define('BASE_URL','http://joby.eu.pn/'); // always include the trailing slash at the end

// DATABASE SETTINGS
define('DB_HOST', 'fdb14.freehostingeu.com');
define('DB_NAME', '2010837_joby');
define('DB_USER', '2010837_joby');
define('DB_PASS', '2010837_joby');
